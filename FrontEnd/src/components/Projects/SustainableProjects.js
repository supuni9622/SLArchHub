...
function SustainableDesignProjects(){
    ...
    const getProjects = (variables) => {
        Axios.post('http://localhost:5000/projects/get-Sustainable-Projects', variables)
            .then(response => {
...
return(
    ...
    <div style={{ textAlign: 'center', margin: '2rem' }}>
        <h2 style={{color:'black', fontWeight:'bold'}}>    SUSTAINABLE DESIGN PROJECTS   </h2>
    </div>
...
export default SustainableDesignProjects
