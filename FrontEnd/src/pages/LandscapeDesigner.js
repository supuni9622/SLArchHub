...
*/
    ...
    const getUsers = (variables) => {
        Axios.post('http://localhost:5000/service-provider/get-Landscape-Designers', variables)
            .then(response => {
...
return(
    ...
    <div style={{ textAlign: 'center', margin: '2rem' }}>
        <h2 style={{color:'black', fontWeight:'bold'}}>  LANDSCAPE DESIGNERS   </h2>
    </div>
     {/* Search  */}
     {/*}
