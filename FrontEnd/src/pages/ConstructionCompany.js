...
*/
    ...
    const getUsers = (variables) => {
        Axios.post('http://localhost:5000/service-provider/get-Construction-company', variables)
            .then(response => {
    ...
    const renderCards = Users.map((user, index) => {
        ...
        <Card style={{ width: '16.5rem', height: '20rem', padding: '10px', margin: '10px', boxShadow: '2px 6px 10px 0 rgba(0, 0, 0, 0.5), 2px 8px 24px 0 rgba(0, 0, 0, 0.5)' }}>
...
return(
    ...
    <div style={{ textAlign: 'center', margin: '2rem' }}>
        <h2 style={{color:'black', fontWeight:'bold'}}>  CONSTRUCTION COMPANIES   </h2>
    </div>
     {/* Search  */}
     {/*}
